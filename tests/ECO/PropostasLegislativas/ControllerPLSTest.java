...
class ControllerPLSTest {
    ...
    // TESTE CONCLUIDO, CREIO QUE NAO MEXEREI MAIS.
    @Test
    void cadastrarPL() {
    ...
    // TESTE CONCLUIDO, ACHO QUE NAO MEXEREI MAIS.
    @Test
    void exibirProjeto() {
    ...
    void verificaBooleanConclusivo() {
        ...
        assertFalse(controlePLS.verificaBooleanConclusivo("PL 2/2010"));
        assertTrue(controlePLS.verificaBooleanConclusivo("PL 3/2005"));
    }
